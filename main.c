 ...
 * Si l'initialisation est possible, on empile les valeurs rentrees en ligne de commande par l'utilisateur (suppose correctes). Si la pile est non vide et que tout s'est bien passe, on va inverser notre pile, et on affiche le premier element
 * de la pile pour montrer que l'inversion s'est bien deroule. On libere la pile si son initilisation a bien ete faite
 * \return CodeErreur Le code d'erreur, qui vaut OK (1) si tout s'est bien passe sinon autre chose
*/
